          ...
          <section className="flex-1 space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link href="/app" className="w-full sm:w-auto">
                <Button
                  className="inline-flex w-full items-center justify-center gap-2 sm:w-auto shadow-lg shadow-primary/30"
                  size="lg"
                >
                  Ver demo del panel
          ...
          <section className="flex-1" id="metrics">
            <div className="relative mx-auto max-w-md">
                  ...
                  <div className="flex items-end justify-between gap-4">
                    <div className="flex flex-1 items-end gap-1">
                      {[40, 60, 45, 80, 55].map((h, i) => (
                        <div
                          key={i}
                          className="flex-1 rounded-full bg-linear-to-t from-primary/10 to-primary/80"
                          style={{ height: `${h}%` }}
                        />
                      ))}
                    </div>
              ...
              <div className="pointer-events-none absolute -left-10 bottom-10 hidden flex-col gap-3 text-[10px] text-muted-foreground md:flex">
                <div className="rounded-full bg-card px-3 py-1.5 shadow-lg shadow-primary/30">
